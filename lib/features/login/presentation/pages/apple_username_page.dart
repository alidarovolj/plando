...
class AppleUsernamePage extends ConsumerStatefulWidget {
  final String email;
  ...
  @override
  ConsumerState<AppleUsernamePage> createState() => _AppleUsernamePageState();
}

class _AppleUsernamePageState extends ConsumerState<AppleUsernamePage> {
  ...
  Future<void> _handleContinue() async {
    ...
    try {
      ...
      print('Apple Registration parameters:');
      print('Email: ${widget.email}');
      print(
          'Identity Token: ${widget.identityToken.substring(0, 20)}...'); // Only print part of the token for security
      print('Username: ${_usernameController.text}');

      // Register the user with Apple
      final result = await userService.signUpWithApple(
        widget.identityToken,
        "", // Пустая строка вместо authorizationCode
